  ...
  return (
    <><Helmet>
        ...
        <Banner title={'Help and Support'} 
            subtitle={'Get the assistance you need with our comprehensive help and support resources. Whether you have questions or need guidance, we’re here to help!'}/>
    ...
    <h1 className="text-3xl font-bold mb-6">Support & FAQs</h1>     
      <div className="join join-vertical w-full">
        ...
        <div className="collapse collapse-arrow border border-base-300 rounded-box">
          ...
          <div className="collapse-content">
            <p>We offer a 30-day return policy on most gadgets. Please check the return page for details.</p>
          </div>
        </div>
        <div className="collapse collapse-arrow border border-base-300 rounded-box">
          <input type="radio" name="faq" />
