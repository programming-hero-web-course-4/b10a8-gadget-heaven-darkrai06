...
import { getOldListData,removeFromWishList } from '../../utilities/addingWishlist';
                            ...
                            {}
                                    ...
                                    <div className="modal-box">
                                        <div className='flex flex-col items-center gap-2'>
                                            ...
                                            <div>
                                                <h2 className='font-semibold my-2 text-lg text-teal-700'>Payment Succesful</h2>
                                            </div>
                                            ...
                                            <form method="dialog">
                                           <div>
                                           <button onClick={()=>handleClosePurchase()} className="px-3 py-1 my-1 rounded-lg bg-gray-400 shadow text-teal-700">Close</button>
                                           </div>
                                        </form>
                                        </div>
                                    </div>
